...
class Elevator(models.Model):
    ...
    running_status = models.CharField(max_length=50, choices=RUNNING_STATUS, default="stop")
    door_status = models.CharField(max_length=50, choices=DOOR_STATUS, default="close")
